...
### 1. Análisis de Conversión - MercadoLibre
* **Problema:** Caída en la conversión de pagos.
* **Qué hice:** Consultas SQL para detectar fugas en el embudo de ventas.
* **Resultado:** Identificación de un 15% de abandono en móviles.

### 2. Movilidad Urbana y Economía
* **Problema:** Correlación entre tráfico y PIB.
* **Qué hice:** Análisis estadístico con Python.
* **Resultado:** Validación de impacto económico por infraestructura.
